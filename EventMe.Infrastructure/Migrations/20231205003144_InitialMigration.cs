    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Идендификатор на събитие")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    PlaceId = table.Column<int>(type: "int", nullable: false, comment: "Идетдификатор на мястото"),
